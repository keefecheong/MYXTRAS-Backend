...
// get controllers
const { updateThread } = require("../controllers/threadSaveController.js");
const { deleteThread } = require("../controllers/threadDeleteController.js");
...
// update thread
specificRouter.patch(
  "/",
  multerConfig.array("picture"),
  multerErrorHandler,
  updateThread,
);
