...
const { REPORT_TARGET_TYPE_POST } = require("../../report/models/report.js");
...
const {
  cacheNewPost,
  updateCachedPost,
} = require("../cache/postUpdateCache.js");
...
async function updatePost(req, res) {
  ...
  try {
    ...
    const moderationPromises =
      updatedValues?.content_links?.map((link) => moderateImage(link)) || [];
    ...
    const updateCacheResult = await updateCachedPost(
      updatedValues,
      userId,
      postId,
      res.postFromCache
