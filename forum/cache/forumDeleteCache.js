...
const { cachedThreadRemoveLikeByUser } = require('../../thread/cache/threadLikeCache.js');
const { cachedThreadRemoveDislikeByUser } = require('../../thread/cache/threadDislikeCache.js');
