...
const getJoinedReasons = require("../../admin/utils/moderation/getJoinedReasons.js");
...
function createReportAfterModeration(
  moderationPromises,
  reportTarget,
  reportTargetType,
  reportTargetOwner,
  ...
  const promise = Array.isArray(moderationPromises)
    ? moderationPromises.length > 1
      ? Promise.all(moderationPromises)
      : moderationPromises[0]
    : moderationPromises;
