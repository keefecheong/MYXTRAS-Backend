...
const { getThread } = require("../../thread/middleware/getThreadMiddleware.js");
const {
  getComment,
...
const { submitReport } = require("../controllers/submitReportController.js");
...
submitReportRouter.post(
  ...
  (req, res) =>
    submitReport(
      ...
      REPORT_TARGET_TYPE_POST,
      req.params.postId,
      res.post.creator_id._id,
    ),
);

// report forum
submitReportRouter.post("/forum/:forumId", getForum, (req, res) =>
  submitReport(
    req,
    res,
    REPORT_TARGET_TYPE_FORUM,
    req.params.forumId,
    res.forum.creator_id._id,
  ),
);
...
// report message
submitReportRouter.post("/message/:messageId", getMessage, (req, res) =>
  submitReport(
    req,
    res,
    REPORT_TARGET_TYPE_MESSAGE,
    req.params.messageId,
    res.message.creator_id._id,
  ),
);
