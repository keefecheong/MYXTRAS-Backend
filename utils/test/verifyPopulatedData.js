...
} = require("../../user/test/verifyPopulateUsers.js");
const {
  verifyDBPopulatedPosts,
  verifyCachePopulatedPosts,
} = require("../../post/test/verifyPopulatePosts.js");
const {
  verifyDBPopulatedForums,
  verifyCachePopulatedForums,
} = require("../../forum/test/verifyPopulateForums.js");
const {
  verifyDBPopulatedThreads,
  verifyCachePopulatedThreads,
} = require("../../thread/test/verifyPopulateThreads.js");
const {
  verifyDBPopulatedComments,
  verifyCachePopulatedComments,
} = require("../../comment/test/verifyPopulateComments.js");
const {
  verifyDBPopulatedChats,
} = require("../../chat/test/verifyPopulateChats.js");
const {
  verifyDBPopulatedMessages,
} = require("../../chat/test/verifyPopulateMessages.js");
  ...
  for (const object of objects) {
    switch (object) {
      ...
      case VERIFY_POPULATED_DATA_POST_COMMENTS:
        ...
        tests.push(
          verifyCachePopulatedComments(data.postIds, PARENT_MODEL_POST),
        );
      ...
      case VERIFY_POPULATED_DATA_THREAD_COMMENTS:
        ...
        tests.push(
          verifyCachePopulatedComments(data.threadIds, PARENT_MODEL_THREAD),
        );
